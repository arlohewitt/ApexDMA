...
// Core
constexpr uint64_t OFF_LEVEL = 0x01BB45E4;                         //[Miscellaneous]->LevelName
constexpr uint64_t OFF_LOCAL_PLAYER = 0x026C6FE8;                 //[Miscellaneous]->LocalPlayer
constexpr uint64_t OFF_ENTITY_LIST = 0x6b6bd88;                 //[Miscellaneous]->cl_entitylist
constexpr uint64_t OFF_OBSERVER_LIST = 0x6b6dda8;


constexpr uint64_t OFF_NAME_LIST = 0x95a6d90;                     //[Miscellaneous]->NameList
constexpr uint64_t OFF_NAME_INDEX = 0x38;                         //nameIndex

// HUD
constexpr uint64_t OFF_VIEWRENDER = 0x336fde0;                    //[Miscellaneous]->ViewRenderer
...
constexpr uint64_t OFF_INATTACK = 0x0336ff10;                    //[Buttons]->in_attack
...
constexpr uint64_t OFF_PROJECTILESCALE = 0x2784;         //projectile_gravity_scale + [WeaponSettingsMeta]base
...
constexpr uint64_t OFF_CURRENTZOOMFOV = 0x16ec;          //m_playerData + m_curZoomFOV
constexpr uint64_t OFF_TARGETZOOMFOV = 0x1630 + 0x00bc;           //m_playerData + m_targetZoomFOV
...
// Glow
constexpr uint64_t OFF_GLOW_HIGHLIGHTS = 0x72B5330;               //HighlightSettings
