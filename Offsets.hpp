...
// Core
constexpr uint64_t OFF_LEVEL = 0x16f94f0;                         //[Miscellaneous]->LevelName
constexpr uint64_t OFF_LOCAL_PLAYER = 0x21830f8;                  //[Miscellaneous]->LocalPlayer
constexpr uint64_t OFF_ENTITY_LIST = 0x1DD45F8;                   //[Miscellaneous]->cl_entitylist


constexpr uint64_t OFF_NAME_LIST = 0xC5FF080;                     //[Miscellaneous]->NameList
constexpr uint64_t OFF_NAME_INDEX = 0x38;                         //nameIndex

// HUD
constexpr uint64_t OFF_VIEWRENDER = 0x73f1978;                    //[Miscellaneous]->ViewRenderer
...
constexpr uint64_t OFF_INATTACK = 0x073f2c18;                     //[Buttons]->in_attack
...
// Glow
constexpr uint64_t OFF_GLOW_HIGHLIGHTS = 0xBB247D0;               //HighlightSettings
